FactoryGirl.define do
  sequence(:radius)              { [2,5,10,20,30,50].sample }
  ...
  sequence(:radius_choice)       { FactoryGirl.generate(:radius) }
  ...
  factory :property_search, class: 'Property::Search' do
    trait :copenhagen do
    ...
    factory :valid_property_search, traits: [:valid] 
  end
end